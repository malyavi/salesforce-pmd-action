...
export function resolveConfig() {
  ...
  return {
    ...
    mode,
    sourceDirs,
    // The extensions PMD has a Salesforce language for, and no more; an empty
    // list clears the filter. See `lib/apex.mjs` for what was measured.
    extensions: listInput('extensions', ['cls', 'trigger', 'page', 'component']),
    configPaths,
    ruleset,
